...
\paragraph{M2.} We have clarified the aim and better explained the results of our user survey (Reviewer xx, xx). This can be found at \FIXME{Section xx}.

\paragraph{M3.} In \FIXME{Section xx}, we provides a discussion on the use of a PSG (Reviewers 1, 4). See also R1.1.

\paragraph{M4.} \FIXME{Section xx} gives further details on our experimental setup per reviewer feedback (Reviewers xx, xx). See also R1.2,
R1.x...

\paragraph{M5.} We have updated \FIXME{Section xx} to include a detailed description of the HMM model (Reviewers 1, 4). See also R1.5.
