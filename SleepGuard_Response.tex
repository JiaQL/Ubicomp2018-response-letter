...
\paragraph{M2.} We have clarified the aim and better explained the results of our user survey (Reviewer xx, xx). This can be found at Section 4.2.4.
...
%=======
%\paragraph{M1.} We have better highlighted the motivation and scientific contributions of the work in Section 1\FIXME{Section xx} and demonstrated that how our work can lead to
%a better understanding of the sleep quality in Section 4.2.4 \FIXME{Section xx}.
%
%\paragraph{M2.} We have clarified the aim and better explained the results of our user survey. This can be found at Section 4.2.4 \FIXME{Section xx}.
%
%\paragraph{M3.} In Section 1 and Section 6 \FIXME{Section xx}, we provides a discussion on the use of a PSG.
%
%\paragraph{M4.} Section 2.1 \FIXME{Section xx} gives further details on our experimental setup per reviewer feedback.
%
%\paragraph{M5.} We have updated Section 2.4 \FIXME{Section xx} to include a detailed description of the HMM model.
