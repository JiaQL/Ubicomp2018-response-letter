...
\paragraph{M1.} We have better highlighted the motivation and scientific contributions of the work in \FIXME{Section xx} and demonstrated that how our work can lead to
a better understanding of the sleep quality in \FIXME{Section xx}.

\paragraph{M2.} We have clarified the aim and better explained the results of our user survey. This can be found at \FIXME{Section xx}.

\paragraph{M3.} In \FIXME{Section xx}, we provides a discussion on the use of a PSG.

\paragraph{M4.} \FIXME{Section xx} gives further detailed information of our experimental setup per reviewer feedback.

\paragraph{M5.} We have updated \FIXME{Section xx} to include a detailed description of the HMM model.
...
found at \FIXME{Section xx}.

\paragraph{M7.} We have made all the minor correction suggested by the reviewers and some others.
