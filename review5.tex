...
%primarily due to the noise in the data. As such, we have designed a set of algorithms to extract useful information from the noisy sensor data. New evidences are provided in Section 4.2.4 to show the usefulness of our approach. We have also extended \FIXME{Section xx} to discuss the limitation of our work. Thanks for the comments.
