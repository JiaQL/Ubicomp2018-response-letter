...
events. This is now clarified in \FIXME{Section xx}.
...
\paragraph{R1.11} We have given the parameters for the moving average filter in Section 2.1 in the revised version. Thanks.
\vspace{-2mm}
